...
import serviciowebcine.Reservas;
...
public class ReservasFacadeREST extends AbstractFacade<Reservas> {
    ...
    @Path("{id}")
    @Consumes({"application/xml", "application/json"})
    public void edit(@PathParam("id") String id, Reservas entity) {
        super.edit(entity);
    }
    ...
    public Reservas find(@PathParam("id") String id) {
