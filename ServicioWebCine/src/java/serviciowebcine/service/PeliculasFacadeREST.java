...
import serviciowebcine.Peliculas;
 ...
 */
@Stateless
@Path("serviciowebcine.peliculas")
public class PeliculasFacadeREST extends AbstractFacade<Peliculas> {
    ...
    @Path("{id}")
    @Consumes({"application/xml", "application/json"})
    public void edit(@PathParam("id") String id, Peliculas entity) {
        super.edit(entity);
    }
    ...
    public Peliculas find(@PathParam("id") String id) {
